"""PR007 — final interior render: mid-height cameras looking down at furniture in rooms."""
import bpy, os
...
# mid-height 3/4 views that look down at furniture clusters (guaranteed to show furniture + room)
shoot("living_room_repaired", (2.0, 31.5, 5.0), (4.0, 35.5, 0.3))
shoot("master_bedroom_repaired", (2.0, 40.5, 5.0), (4.0, 37.5, 0.3))
