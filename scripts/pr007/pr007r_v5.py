"""PR007R v5 — fix kitchen (north cam) + bedroom (wardrobe cam) + interior motion."""
...
# kitchen: north camera (verified clear LOS, showed furniture in v3)
shoot("kitchen_dining", (10.0, 38.5, 3.0), (10.2, 35.5, 1.0))
# bedroom: aimed at tall wardrobe (5.5,37, h=2.4m)
shoot("master_bedroom", (4.0, 33.0, 2.5), (5.3, 37.3, 1.4))

# interior motion: lateral dolly through living room good region (x 3->5.5)
...
for f in range(1, N + 1):
    t = (f - 1) / (N - 1)
    cam.location = Vector((3.0 + t * 2.5, 31.0, 3.5))
